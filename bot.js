...
async function processUpdate(update) {
  if ('message' in update) {
    ...
    switch (true) {
      case userText === '/start':
        await sendMessage(chatId, 'Wᴇʟᴄᴏᴍᴇ ᴛᴏ Nᴏᴏʙ Mᴀɪʟ Noob Mail 💌 ✉\n\nWhy Noob Mail 💌?\n\nWᴇ ᴘʀᴏᴠɪᴅᴇ ʏᴏᴜ sᴇᴄᴜʀᴇ 🔐 ғᴀsᴛ 🔥 ʀᴇʟɪᴀʙʟᴇ ᴅɪsᴘᴏsᴀʙʟᴇ ᴍᴀɪʟ sᴇʀᴠɪᴄᴇ\n\nYou can use the following command:\n/generate_email - Generate a temporary email address\n\nTʜᴀɴᴋ Yᴏᴜ 🙏');
        break;
